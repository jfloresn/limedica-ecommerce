...
namespace BaseCommon.Common
{
   public class Comun
    {
        public static string TEMPDATA_MENSAJE = "TEMPDATA_MENSAJE";
        public static string TEMPDATA_ESTADO_MENSAJE = "TEMPDATA_ESTADO_MENSAJE";
        public static string TEMPDATA_CREAR_CUENTA = "TEMPDATA_CREAR_CUENTA";

        // Inicio sesion de usuario
        public static string COOKIES_SESION = "CookiesSesion";
        // Fin Sesion de usuario
