...
namespace System.Web.Mvc.Html
{
    ...
    public class Helpers
    {
        ...
        /// </summary>
        /// <param name="Tag">The tag to apply the attributes.</param> <param name="Attributes">The attributes to be added to the tag. Attention: Separate the key from the value with an equal (=) character.</param>
        ...
        public static CultureInfo GetCurrentCulture()
        {
            try
            {
                ...
                var section = WebConfigurationManager.OpenWebConfiguration("/").GetSection("system.web/globalization") as System.Web.Configuration.GlobalizationSection;
